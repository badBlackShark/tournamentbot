class TournamentBot::Match
  ...
  def start_draft(guild, draft_role)
    ...
    welcome_message = "Welcome to your draft phase. You can ban a map by typing `!ban <mapName>` and pick a map by "\
                      ...
                      "and picked #{@tournament.picks_per_player} map(s). <@#{@participants.first}> starts the first round.\n"\
                      ...
                      "All participants of this match will have to agree to this by also typing `!allow`."
